...
class ProductTemplate(models.Model):
    ...
    list_price_tax_included = fields.Float(
        compute="_compute_standard_price_tax_included",
    ...
    @api.depends(
        ...
        "product_variant_ids.list_price",
        "taxes_id",
    ...
    def _compute_standard_price_tax_included(self):
        ...
        for template in unique_variants:
            template.standard_price_tax_included = (template.product_variant_ids.standard_price_tax_included)
            template.list_price_tax_included = (template.product_variant_ids.list_price_tax_included)
        for template in self - unique_variants:
            template.standard_price_tax_included = 0.0
            template.list_price_tax_included = 0.0
